  ...
  const properties = [
    {
      ...
      image: Bakota,
      detailText: 'Стародавні печери на березі Дністровського водосховища, що вражають своєю історією та красою. Наші будиночки розкинулися на пагорбах з видом на безкрайні водні простори та каньйон. Ви можете обрати кількість кімнат та місць, яке буде ідеальним для Вас. Територія, де розташовані будиночки, підійде як і для великих компаній, яким потрібно бути поряд у декількох будинках, так і для пар, які хочуть бути на одинці.'
    },
    {
      id: 2,
      ...
      image: Karpaty,
      detailText: 'Затишні дерев\'яні будиночки, які захоплять вас на околиці лісу, зустрічають Вас судомним краєвидом на ранкові полонини. Ви можете обрати кількість кімнат та місць, яке буде ідеальним для Вас. Територія, де жити безпечна будиночка, підійде як і для великих компаній, яким потрібно бути поряд у декількох будинках, так і для пар, які хочуть бути на одинці.'
    },
    {
      id: 3,
      ...
      image: Kyiv,
      detailText: 'Автентичні українські хати на території музею просто неба, де оживає історія наших предків. Наші будиночки стилізовані під традиційну архітектуру з усіма сучасними зручностями. Ви можете обрати кількість кімнат та місць, яке буде ідеальним для Вас. Територія, де розташовані будиночки, підійде як і для великих компаній, яким потрібно бути поряд у декількох будинках, так і для пар, які хочуть бути на одинці.'
    },
    {
      id: 4,
      ...
      image: Odessa,
      detailText: 'Українська Венеція з мережею каналів, де життя пливе у ритмі води і човнів. Наші будиночки розташовані на березі каналів з власними причалами та видом на дельту Дунаю. Ви можете обрати кількість кімнат та місць, яке буде ідеальним для Вас. Територія, де розташовані будиночки, підійде як і для великих компаній, яким потрібно бути поряд у декількох будинках, так і для пар, які хочуть бути на одинці.'
    }
  ];
